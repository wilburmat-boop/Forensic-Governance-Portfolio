...
sed -i "82a <button class=\"tab-btn\" onclick=\"showPanel('market-misrep', event)\">\&#128200; Market Misrepresentation</button>" index.html
...
marker = '<div id="constitution" class="panel">'
idx = content.find(marker)
if idx == -1:
    raise SystemExit("ERROR: could not find constitution panel marker")
